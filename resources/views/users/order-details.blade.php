                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach ($orderItems as $orderitem)
                                    <tr>
                                        ...
                                        <td class="text-center">SAR {{$orderitem->price}}</td>
                    ...
                    <div class="wg-box mt-5">
                        ...
                        <div class="my-account__address-item col-md-6">
                            <div class="my-account__address-item__detail">
                                ...
                                <p>City : {{$transaction->order->city}}, {{$transaction->order->country}}</p>
                    ...
                    <div class="wg-box mt-5">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-transaction">
                                <tr>
                                    <th>Subtotal</th>
                                    <td>SAR {{$transaction->order->subtotal}}</td>
                                    <th>Tax</th>
                                    <td>SAR {{$transaction->order->tax}}</td>
                                    <th>Discount</th>
                                    <td>SAR {{$transaction->order->discount}}</td>
                                </tr>
                                <tr>
                                    <th>Total</th>
                                    <td>SAR {{$transaction->order->total}}</td>
                                    <th>Payment Mode</th>
    ...
    <script>
        $(function (){
            $('.cancel-order').on('click',function (e){
                ...
                swal({
                    title: "Are You Sure?",
                    text: "You Went To Cancel This Order>",
                    type: "warning",
                    buttons: ["No","Yes"],
