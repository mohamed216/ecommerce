                ...
                <div class="wg-box">
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap10">
                                <h4>SAR {{$TotalDeliveredAmount}}</h4>
                            </div>
                        </div>
                        <div>
                            <div class="mb-2">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="text-center">SAR {{$order->subtotal}}</td>
                                        <td class="text-center">SAR {{$order->tax}}</td>
                                        <td class="text-center">SAR {{$order->total}}</td>
