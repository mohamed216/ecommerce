                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide product-card product-card_style3">
                                        <div class="pc__img-wrapper">
                                            <a href="{{route('shop.product.details',['product_slug'=>$sproduct->slug])}}">{{$sproduct->name}}">
                                                <img loading="lazy" src="{{asset('uploads/products')}}/{{$sproduct->image}}" width="258" height="313"
                                                     alt="{{$sproduct->category->name}}" class="pc__img">
                                                <img loading="lazy" src="{{asset('uploads/products')}}/{{$sproduct->image}}" width="258" height="313"
                                                     alt="{{$sproduct->category->name}}" class="pc__img pc__img-second">
                                            </a>
                                        </div>
                                            ...
                                            <div class="product-card__price d-flex">
                                                <span class="money price text-secondary">
                                                      @if($sproduct->sale_price)
                                                        <s>SAR {{$sproduct->regular_price}}</s> SAR {{$sproduct->sale_price}}
                                                    @else
                                                       SAR {{$sproduct->regular_price}}
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="product-card__price d-flex align-items-center">
                                    <span class="money price text-secondary">
                                         @if($fproduct->sale_price)
                                            <s>SAR {{$fproduct->regular_price}}</s> SAR {{$fproduct->sale_price}}
                                        @else
                                          SAR  {{$fproduct->regular_price}}
                                        @endif
                                    </span>
                                </div>
                            </div>
