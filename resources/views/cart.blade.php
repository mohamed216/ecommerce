                        ...
                        <table class="cart-table">
                            ...
                            @foreach ($cartItems as $cartItem)
                                <tr>
                                    ...
                                    <td>
                                        <span class="shopping-cart__product-price">SAR {{$cartItem->price}}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="shopping-cart__subtotal">SAR {{$cartItem->subTotal()}}</span>
                                    </td>
                                    <td>
                            ...
                            <div class="shopping-cart__totals">
                                ...
                                @if(Session::has('discounts'))
                                    <table class="cart-totals">
                                        ...
                                        <tr>
                                            <th>Subtotal</th>
                                            <td>SAR {{Cart::instance('cart')->subtotal()}}</td>
                                        </tr>
                                        <tr>
                                            <th>Discount {{Session("coupon")["code"]}}</th>
                                            <td>-SAR {{Session("discounts")["discount"]}}</td>
                                        </tr>
                                        <tr>
                                            <th>Subtotal After Discount</th>
                                            <td>SAR {{Session("discounts")["subtotal"]}}</td>
                                        </tr>
                                        <tr>
                                            <th>SHIPPING</th>
                                        ...
                                        <tr>
                                            <th>VAT</th>
                                            <td>SAR {{Session("discounts")["tax"]}}</td>
                                        </tr>
                                        <tr class="cart-total">
                                            <th>Total</th>
                                            <td>SAR {{Session("discounts")["total"]}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                @else
                                    <table class="cart-totals">
                                        ...
                                        <tr>
                                            <th>VAT</th>
                                            <td>SAR {{Cart::instance('cart')->tax()}}</td>
                                        </tr>
                                        <tr class="cart-total">
                                            <th>Total</th>
                                            <td>SAR {{Cart::instance('cart')->total()}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                @endif
