...
@section('content')
    <style>
        ...
        brand-list li .chk-brand , .category-list .chk-category{
            width: 1rem;
            height: 1rem;
            color: #E4E4E4;
                                ...
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            ...
                                            <span class="text-right float-end">{{$brand->products()->count()}}
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    ...
                                    <span class="price-range__min">SAR 250</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Max Price: </span>
                                    <span class="price-range__max">SAR 450</span>
                                </div>
                            </div>
                        </div>
                    </div>
              ...
              "clickable": true
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" style="margin-right:20px;" aria-label="Page Size" id="orderby" name="orderby">
    ...
    <form id="frmfilter" method="Get" action="{{route('shop.index')}}">
        @csrf
        <input type="hidden" name="page" value="{{$product->currentpage}}">
